...
from myutils import button_text, dict_commands, fontStyle_medium, borderwidth
...
class CommandSettingsWindow(Frame):
    def __init__(self, parent: Tk, main):
        ...
        label_buttons = Label(frame1, text='Button names', font=fontStyle_medium)
        label_commands = Label(frame1, text='Transmitted data', font=fontStyle_medium)
