...
class ConfigurePlotWindow(Frame):
    ...
    def __setup__(self):
        frame_color = LabelFrame(self._root,
                                 text='Color settings',
                                 font=fontStyle_medium,
                                 borderwidth=borderwidth)
        frame_target_apogee = LabelFrame(self._root,
                                         text='Target apogee',
                                         font=fontStyle_medium,
                                         borderwidth=borderwidth)
        frame_velocity = LabelFrame(self._root,
                                    text='Velocity reference line',
                                    font=fontStyle_medium,
                                    borderwidth=borderwidth)

        frame_color.pack(side="top", fill="both", expand=True, padx=15, pady=15)
        frame_target_apogee.pack(side="top", fill="both", expand=True, padx=15, pady=15)
        frame_velocity.pack(side="top", fill="both", expand=True, padx=15, pady=15)
