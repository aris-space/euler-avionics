...
void ReadDataUSB() {
	if (osMutexAcquire(usb_data_mutex.mutex, 10)) {
		sscanf(usb_data_buffer,
				"%ld,%ld,%ld;%hd,%hd,%hd,%hd,%hd,%hd,%ld|%ld,%ld,%ld;%hd,%hd,%hd,%hd,%hd,%hd,%ld|%ld,%ld,%ld;%hd,%hd,%hd,%hd,%hd,%hd,%ld\n",
				&sb1_baro.pressure, &sb1_baro.temperature, &sb1_baro.ts,
				&sb1_imu.gyro_x, &sb1_imu.gyro_y, &sb1_imu.gyro_z,
				&sb1_imu.acc_x, &sb1_imu.acc_y, &sb1_imu.acc_z, &sb1_imu.ts,
				&sb2_baro.pressure, &sb2_baro.temperature, &sb2_baro.ts,
				&sb2_imu.gyro_x, &sb2_imu.gyro_y, &sb2_imu.gyro_z,
				&sb2_imu.acc_x, &sb2_imu.acc_y, &sb2_imu.acc_z, &sb2_imu.ts,
				&sb3_baro.pressure, &sb3_baro.temperature, &sb3_baro.ts,
				&sb3_imu.gyro_x, &sb3_imu.gyro_y, &sb3_imu.gyro_z,
