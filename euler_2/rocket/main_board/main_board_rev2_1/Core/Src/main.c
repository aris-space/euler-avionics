...
const osThreadAttr_t task_state_est_attributes = { .name = "task_state_est",
		.stack_mem = &task_state_estBuffer[0], .stack_size =
				sizeof(task_state_estBuffer), .cb_mem =
				&task_state_estControlBlock, .cb_size =
				sizeof(task_state_estControlBlock), .priority =
...
const osThreadAttr_t task_controller_attributes = { .name = "task_controller",
		.stack_mem = &task_controllerBuffer[0], .stack_size =
				sizeof(task_controllerBuffer), .cb_mem =
				&task_controllerControlBlock, .cb_size =
				sizeof(task_controllerControlBlock), .priority =
				(osPriority_t) osPriorityNormal, };
...
const osThreadAttr_t task_sens_read_attributes = { .name = "task_sens_read",
		.stack_mem = &task_sens_readBuffer[0], .stack_size =
				sizeof(task_sens_readBuffer), .cb_mem =
				&task_sens_readControlBlock, .cb_size =
				sizeof(task_sens_readControlBlock), .priority =
				(osPriority_t) osPriorityNormal, };
...
const osThreadAttr_t task_sd_card_attributes = { .name = "task_sd_card",
		.stack_mem = &task_sd_cardBuffer[0], .stack_size =
				sizeof(task_sd_cardBuffer), .cb_mem = &task_sd_cardControlBlock,
		.cb_size = sizeof(task_sd_cardControlBlock), .priority =
				(osPriority_t) osPriorityNormal, };
...
const osThreadAttr_t task_motor_cont_attributes = { .name = "task_motor_cont",
		.stack_mem = &task_motor_contBuffer[0], .stack_size =
				sizeof(task_motor_contBuffer), .cb_mem =
				&task_motor_contControlBlock, .cb_size =
				sizeof(task_motor_contControlBlock), .priority =
				(osPriority_t) osPriorityNormal, };
/* Definitions for task_fsm */
osThreadId_t task_fsmHandle;
uint32_t task_fsmBuffer[2048];
osStaticThreadDef_t task_fsmControlBlock;
const osThreadAttr_t task_fsm_attributes = { .name = "task_fsm", .stack_mem =
		&task_fsmBuffer[0], .stack_size = sizeof(task_fsmBuffer), .cb_mem =
		&task_fsmControlBlock, .cb_size = sizeof(task_fsmControlBlock),
...
const osThreadAttr_t task_gps_attributes = { .name = "task_gps", .stack_mem =
		&task_gpsBuffer[0], .stack_size = sizeof(task_gpsBuffer), .cb_mem =
		&task_gpsControlBlock, .cb_size = sizeof(task_gpsControlBlock),
		.priority = (osPriority_t) osPriorityNormal, };
...
const osThreadAttr_t task_battery_attributes = { .name = "task_battery",
		.stack_mem = &task_batteryBuffer[0], .stack_size =
				sizeof(task_batteryBuffer), .cb_mem = &task_batteryControlBlock,
		.cb_size = sizeof(task_batteryControlBlock), .priority =
				(osPriority_t) osPriorityNormal, };
...
const osThreadAttr_t task_xbee_attributes = { .name = "task_xbee", .stack_mem =
		&task_xbeeBuffer[0], .stack_size = sizeof(task_xbeeBuffer), .cb_mem =
		&task_xbeeControlBlock, .cb_size = sizeof(task_xbeeControlBlock),
		.priority = (osPriority_t) osPriorityNormal, };
...
const osThreadAttr_t task_peripherals_attributes = { .name = "task_peripherals",
		.stack_mem = &task_peripheralsBuffer[0], .stack_size =
				sizeof(task_peripheralsBuffer), .cb_mem =
				&task_peripheralsControlBlock, .cb_size =
				sizeof(task_peripheralsControlBlock), .priority =
				(osPriority_t) osPriorityNormal, };
/* USER CODE BEGIN PV */
...
void SystemClock_Config(void) {
	...
	PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_USART3
			| RCC_PERIPHCLK_USART2 | RCC_PERIPHCLK_UART4 | RCC_PERIPHCLK_UART7
			| RCC_PERIPHCLK_USART1 | RCC_PERIPHCLK_SPI4 | RCC_PERIPHCLK_SPI3
