...
/****** Port Name ************************************* Code ** Official ** OS
 * Platform *********/
#define TRC_HARDWARE_PORT_APPLICATION_DEFINED \
  98 /*	-			-					*/
#define TRC_HARDWARE_PORT_NOT_SET \
  99 /*	-			-					*/
#define TRC_HARDWARE_PORT_HWIndependent \
  0 /*	Yes			Any					*/
#define TRC_HARDWARE_PORT_Win32 \
  1 /*	Yes			FreeRTOS on Win32	*/
#define TRC_HARDWARE_PORT_Atmel_AT91SAM7 \
  2 /*	No			Any					*/
#define TRC_HARDWARE_PORT_Atmel_UC3A0 \
  3 /*	No			Any					*/
#define TRC_HARDWARE_PORT_ARM_Cortex_M \
  4 /*	Yes			Any					*/
#define TRC_HARDWARE_PORT_Renesas_RX600 \
  6 /*	Yes			Any					*/
#define TRC_HARDWARE_PORT_MICROCHIP_PIC24_PIC32 \
  7 /*	Yes			Any					*/
#define TRC_HARDWARE_PORT_TEXAS_INSTRUMENTS_TMS570_RM48 \
  8 /*	Yes			Any					*/
#define TRC_HARDWARE_PORT_TEXAS_INSTRUMENTS_MSP430 \
  9 /*	No			Any					*/
#define TRC_HARDWARE_PORT_XILINX_PPC405 \
  11 /*	No			FreeRTOS			*/
#define TRC_HARDWARE_PORT_XILINX_PPC440 \
  12 /*	No			FreeRTOS			*/
#define TRC_HARDWARE_PORT_XILINX_MICROBLAZE \
  13 /*	No			Any					*/
#define TRC_HARDWARE_PORT_XILINX_ZyncUltraScaleR5 \
  14 /*  No			FreeRTOS			*/
#define TRC_HARDWARE_PORT_NXP_LPC210X \
  15 /*	No			Any					*/
#define TRC_HARDWARE_PORT_ARM_CORTEX_A9 \
  16                                    /*	Yes			Any					*/
#define TRC_HARDWARE_PORT_POWERPC_Z4 17 /*  No          FreeRTOS            */
#define TRC_HARDWARE_PORT_Altera_NiosII \
  18   /*  Yes          Any (Tested with FreeRTOS)                 */
