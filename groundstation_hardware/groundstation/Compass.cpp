...
float Compass::filterAxis(float value, double * registers){
  float filtered;
  filtered = A0 * (value + B1const * registers[0] + B2const * registers[1] + B3const * registers[2] + B4const * registers[3]) + A1const * registers[0] + A2const * registers[1] + A3const * registers[2] + A4const * registers[3];
  registers[3] = registers[2];
  registers[2] = registers[1];
  registers[1] = registers[0];
  registers[0] = value + B1const * registers[0] + B2const * registers[1] + B3const * registers[2] + B4const * registers[3];
  return filtered;
}
